...
quantity_student = slider("How student going?", min_value=1,max_value=100,value=50, step=1)
quantity_teacher = slider("How teacher going?", min_value=1,max_value=20,value=10, step=1)
